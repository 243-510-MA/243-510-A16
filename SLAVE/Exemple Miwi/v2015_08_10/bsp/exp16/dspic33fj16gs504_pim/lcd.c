...
#define LCD_RWSignal_Set()        LATCbits.LATC6 = 1  //set Read/Write bit
#define LCD_RWSignal_Clear()      LATCbits.LATC6 = 0  //clear Read/Write bit
#define LCD_EnableSignal_Set()    LATCbits.LATC13 = 1  //set Enable bit
#define LCD_EnableSignal_Clear()  LATCbits.LATC13 = 0  //clear Enable bit
...
#define LCD_RWSignal_Input()      TRISCbits.TRISC6 = 1  //set Read/Write bit
#define LCD_RWSignal_Output()     TRISCbits.TRISC6 = 0  //clear Read/Write bit
#define LCD_EnableSignal_Input()  TRISCbits.TRISC13 = 1  //set Enable bit
#define LCD_EnableSignal_Output() TRISCbits.TRISC13 = 0  //clear Enable bit
