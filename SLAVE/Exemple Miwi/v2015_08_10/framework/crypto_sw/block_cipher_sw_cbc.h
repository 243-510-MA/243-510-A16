...
#if !defined (_BLOCK_CIPHER_SW_CBC_H)
#define _BLOCK_CIPHER_SW_CBC_H
...
typedef struct
{
    uint8_t __attribute__((aligned)) initializationVector[CRYPTO_CONFIG_SW_BLOCK_MAX_SIZE];      // Initialization vector for the CBC operation
    uint8_t __attribute__((aligned)) remainingData[CRYPTO_CONFIG_SW_BLOCK_MAX_SIZE];             // Buffer to store data until more is avaliable if there is not enough to encrypt an entire block.
...
/* Function:
  ...
  Example:
    ...
    error = BLOCK_CIPHER_SW_CBC_Initialize (handle, &context, AES_SW_Encrypt, AES_SW_Decrypt, AES_SW_BLOCK_SIZE, initialization_vector, &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);
...
/**************************************************************************************************************************************************************************************
  Function:
    BLOCK_CIPHER_SW_ERRORS BLOCK_CIPHER_SW_CBC_Encrypt (BLOCK_CIPHER_SW_HANDLE handle,
  ...
  Input:
    ...
    options -         Block cipher encryption options that the user can
                      ...
                      function are
                      * BLOCK_CIPHER_SW_OPTION_PAD_NONE
                      * BLOCK_CIPHER_SW_OPTION_PAD_NULLS
                      * BLOCK_CIPHER_SW_OPTION_PAD_8000
                      * BLOCK_CIPHER_SW_OPTION_PAD_NUMBER
...
// *****************************************************************************
/* Function:
    BLOCK_CIPHER_SW_ERRORS BLOCK_CIPHER_SW_CBC_Decrypt (BLOCK_CIPHER_SW_HANDLE handle,
  ...
  Example:
    ...
    // Decrypt the data
    BLOCK_CIPHER_SW_CBC_Decrypt (handle, plain_text, &num_bytes_decrypted, (void *) cipher_text, sizeof(cipher_text), BLOCK_CIPHER_SW_OPTION_STREAM_START);
    </code>
*/
