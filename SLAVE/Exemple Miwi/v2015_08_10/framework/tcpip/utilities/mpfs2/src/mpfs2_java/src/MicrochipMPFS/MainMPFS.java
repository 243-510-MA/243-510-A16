...
public class MainMPFS extends javax.swing.JFrame {
    ...
    public String defaultSourceDirectoryPath =
            "C:\\microchip\\mla\\v2014_07_22\\apps\\tcpip\\wifi_demo_app\\firmware\\src\\demo_app_webpages";
            //"C:\\Microchip Solutions\\TCPIP\\Demo App\\WebPages2";
    public String defaultProjectBinFilePath =
            "C:\\microchip\\mla\\v2014_07_22\\apps\\tcpip\\wifi_demo_app\\firmware\\src\\mpfs_img2.bin";
            //"C:\\Microchip Solutions\\TCPIP\\Demo App\\mpfs_img2.bin";
    public String defaultProjectSourceCodeDirectoryPath =
            "C:\\microchip\\mla\\v2014_07_22\\apps\\tcpip\\wifi_demo_app\\firmware\\src";
            //"C:\\Microchip Solutions\\TCPIP\\Demo App";

    public String sourceDirectoryPath =
            "../../../../apps/tcpip/wifi_demo_app/firmware/src/demo_app_webpages";
    ...
    public String projectBinFilePath =
            "../../../../apps/tcpip/wifi_demo_app/firmware/src/mpfs_img2.bin";
            //"../../../TCPIP/Demo App/mpfs_img2.bin";
    ...
    public String projectSourceCodeDirectoryPath =
            "../../../../apps/tcpip/wifi_demo_app/firmware/src";
            //"../../../TCPIP/Demo App";
    public String projectSourceCodeDirectoryPath_old =
            "../../../../apps/tcpip/wifi_demo_app/firmware/src";
            //"../../../TCPIP Demo App";
            //"C:\\Microchip Solutions\\TCPIP\\Demo App";
            //"C:\\Microchip Solutions\\TCPIP Demo App";
    ...
    public String[] XMLNodeSettingAttribute=
    {
      //"DefaultSourceDirectory",
        "SourceDirectory",
      //"SourceDirectory_old",
      //"DefaultProjectSourceCodeDirectory",
        "ProjectSourceCodeDirectory",
      //"ProjectSourceCodeDirectory_old",
...
//                   }
        ...
        aboutStr = "<html>"+"This utility is generated by JDK 1.8"+"<br>";
        String version = "Version MPFS 2.2.2";
        lebelAbout.setText(aboutStr+version+"</html>");
        ...
        File projectSourceCodeDir = new File(projectSourceCodeDirectoryPath);

        File sourceFile_old=new File(sourceDirectoryPath_old);
        File projectBinFile_old = new File(projectBinFilePath_old);
        File projectSourceCodeDir_old = new File(projectSourceCodeDirectoryPath_old);
        // source directory
        try
        {
        ...
        try
        {
            projectSourceCodeDirectoryPath = projectSourceCodeDir.getCanonicalPath();
            if(projectSourceCodeDir.exists() == false)
            {
               if(projectSourceCodeDir_old.exists() == false)
                    projectSourceCodeDirectoryPath = defaultProjectSourceCodeDirectoryPath;
               else
               {
                    projectSourceCodeDirectoryPath = projectSourceCodeDir_old.getCanonicalPath();
               }
            }
            //xmlIntrf.modifyExistingXmlFile("Setting", "ProjectSourceCodeDirectory", projectSourceCodeDirectoryPath);
            saveXmlNodeValue(eXmlNodeAttribute.PROJECT_DIRECTORY_PATH,projectSourceCodeDirectoryPath,0,true);
            //System.out.println("projectSourceCodeDirectoryPath =" + projectSourceCodeDirectoryPath);
        }catch(IOException E){}
         // Soure directory Image path
        TextSrcDir.setText(sourceDirectoryPath);
        txtProjectDir.setText(projectSourceCodeDirectoryPath);
    }
...
*/
    ...
    private void initComponents() {
        ...
        lblProjectDir.setText("Project Source Code Directory:");
        ...
        jPanel2.add(radC18C32, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 30, -1, -1));

        processOpnButGrp.add(radAsm);
        radAsm.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11)); // NOI18N
        radAsm.setText("PIC24 Image");
        ...
        jPanel2.add(radAsm, new org.netbeans.lib.awtextra.AbsoluteConstraints(429, 30, -1, -1));
        ...
        lebelAbout.setText("<html> This utility is generated by JDK 1.8 </html>");
...
//        }catch(Exception ex){}
        ...
        if(outPutVersion == MPFS_OUTPUT_VERSION.MPFS2)
        {
            ...
            //else if (radMdd.isSelected()) // Deleted Old MDD Button
           ...
           String protocol)
   {
           ...
           if((srcPath = browseButton.getDirctoryPath()) != null)
            {
                ...
                projectSourceCodeDirectoryPath = txtProjectDir.getText();
                saveXmlNodeValue(eXmlNodeAttribute.SOURCE_DIRECTORY_PATH,sourceDirectoryPath,0,true);
                saveXmlNodeValue(eXmlNodeAttribute.PROJECT_DIRECTORY_PATH,projectSourceCodeDirectoryPath,0,true);
            }
        }
    ...
    private void radWebDirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radWebDirActionPerformed
       ...
       // java.awt.event.ActionEvent evt;
         ...
         //else if(radMdd.isSelected() == true) // Deleted Old MDD Button
         //{
    ...
    private void btnProjectDirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProjectDirActionPerformed
        ...
        //ProjectDir.setTitle("MPFS Browse Project Source Code Directory");
        ...
        if((projectPath = ProjectDir.getDirctoryPath()) != null)
        {
            ...
            projectSourceCodeDirectoryPath = projectPath;
            saveXmlNodeValue(eXmlNodeAttribute.PROJECT_DIRECTORY_PATH,projectSourceCodeDirectoryPath,0,true);
        }
    ...
    private void TextSrcDirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TextSrcDirActionPerformed
        ...
        if(radWebDir.isEnabled())
        {
            ...
            sourceDirectoryPath = TextSrcDir.getText();
            projectSourceCodeDirectoryPath = txtProjectDir.getText();
            projectBinFilePath = projectSourceCodeDirectoryPath+File.separator+imageName;
            //save the setting
            saveXmlNodeValue(eXmlNodeAttribute.PROJECT_BIN_FILE_PATH,projectBinFilePath,0,true);
            saveXmlNodeValue(eXmlNodeAttribute.SOURCE_DIRECTORY_PATH,sourceDirectoryPath,0,true);
            saveXmlNodeValue(eXmlNodeAttribute.PROJECT_DIRECTORY_PATH,projectSourceCodeDirectoryPath,0,true);
    ...
    void toolTipSettings()
    {
        ...
        radAsm.setToolTipText(infoString+ "Output an image compatible with 16-bit parts" +
                ...
                +"</body></html>");
        //radMdd.setToolTipText(infoString+"Use this option to store pages " + // Deleted Old MDD Button
        ...
        txtProjectDir.setToolTipText(infoString +"Select your MPLAB project " +
                "directory. <br>Your image file will be placed here, <br>al" +
                    "ong with http_print.h if applicable."+"</body></html>");
    ...
    public void setConfiguration(boolean bNodeValue,String sNodeValue,int cNodeValue,int xmlNodeValue)
    {
        switch(xmlNodeValue)
        {
            ...
            case 6:  // OUTPUT_IMAGE_FORMAT_RAD_BOTTON
                ...
                //else if(ouputFormat.get((byte)cNodeValue) == outputFileFormat.MDD) // Deleted Old MDD Button
                //{
    ...
    private void MainKeyEventActionIntialization()
    {
        ...
        KeyStroke enter_projectSourceCodeDir = KeyStroke.getKeyStroke(KeyEvent.VK_ENTER,
                                                                       0, true);
        btnProjectDir.getInputMap(JButton.WHEN_FOCUSED).put(enter_projectSourceCodeDir,
...
//long cmdstartTime  =  System.currentTimeMillis();
            ...
            String projectSourceCodeDir = args[args.length - 2];
            String outputFile = args[args.length - 1];
//            System.out.println("arg len :"+args.length);
//            System.out.println("projectSourceCodeDir :"+projectSourceCodeDir);
...
//                        reserveBlock = Integer.parseInt(args[++i]);
            ...
            if (version == 2)
            {
                builder.MPFS2Builder(projectSourceCodeDir,outputFile);
            ...
            {
                classicBuilder = builder.new MPFSClassicBuilder(projectSourceCodeDir,outputFile);
