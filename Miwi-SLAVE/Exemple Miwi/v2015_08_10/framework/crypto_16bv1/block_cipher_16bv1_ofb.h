...
#if !defined (_BLOCK_CIPHER_16BV1_OFB_H)
#define _BLOCK_CIPHER_16BV1_OFB_H
...
/* Function:
  ...
  Example:
    ...
    error = BLOCK_CIPHER_16BV1_OFB_Initialize (handle, &context, CRYPTO_16BV1_ALGORITHM_AES, CRYPTO_16BV1_ALGORITHM_AES, AES_BLOCK_SIZE, initialization_vector, (void *)&keyStream, sizeof (keyStream), &AESKey128, CRYPTO_KEY_SOFTWARE, CRYPTO_AES_128_KEY);
...
/**************************************************************************************************************************************************************
  ...
  Conditions:
    ...
    The initializationVector parameter in the BLOCK_CIPHER_16BV1_OFB_CONTEXT
  ...
  Example:
    ...
    //Encrypt the data
    BLOCK_CIPHER_16BV1_OFB_Encrypt (handle, cipher_text,(void *) plain_text, sizeof(plain_text), BLOCK_CIPHER_OPTION_STREAM_CONTINUE);
    </code>
...
/***************************************************************************************************************************************************************
  ...
  Example:
    ...
    // Decrypt the data
    BLOCK_CIPHER_16BV1_OFB_Decrypt (handle, plain_text,(void *) cipher_text, sizeof(cipher_text), BLOCK_CIPHER_OPTION_STREAM_CONTINUE);
    </code>
                                                                                                                                                                
  ***************************************************************************************************************************************************************/
BLOCK_CIPHER_ERRORS BLOCK_CIPHER_16BV1_OFB_Decrypt (BLOCK_CIPHER_HANDLE handle, uint8_t * plainText, uint8_t * cipherText, uint32_t numBytes, uint32_t options);
...
#endif      // _BLOCK_CIPHER_16BV1_OFB_H
