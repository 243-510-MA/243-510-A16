...
#if !defined (_BLOCK_CIPHER_SW_OFB_H)
#define _BLOCK_CIPHER_SW_OFB_H
...
/* Function:
  ...
  Example:
    ...
    error = BLOCK_CIPHER_SW_OFB_Initialize (handle, &context, AES_SW_Encrypt, AES_SW_Decrypt, AES_SW_BLOCK_SIZE, initialization_vector, (void *)&keyStream, sizeof (keyStream), &round_keys, CRYPTO_SW_KEY_SOFTWARE_EXPANDED);
...
*/
BLOCK_CIPHER_SW_ERRORS BLOCK_CIPHER_SW_OFB_Initialize (BLOCK_CIPHER_SW_HANDLE handle, BLOCK_CIPHER_SW_OFB_CONTEXT * context, BLOCK_CIPHER_SW_FunctionEncrypt encryptFunction, BLOCK_CIPHER_SW_FunctionDecrypt decryptFunction, uint32_t blockSize, uint8_t * initializationVector, void * keyStream, uint32_t keyStreamSize, void * key, CRYPTO_SW_KEY_TYPE keyType);
...
/**************************************************************************************************************************************************************
  ...
  Conditions:
    ...
    The initializationVector parameter in the BLOCK_CIPHER_SW_OFB_CONTEXT
  ...
  **************************************************************************************************************************************************************/
BLOCK_CIPHER_SW_ERRORS BLOCK_CIPHER_SW_OFB_Encrypt (BLOCK_CIPHER_SW_HANDLE handle, uint8_t * cipherText, uint32_t * numCipherBytes, uint8_t * plainText, uint32_t numPlainBytes, uint32_t options);
...
/***************************************************************************************************************************************************************
  ...
  ***************************************************************************************************************************************************************/
BLOCK_CIPHER_SW_ERRORS BLOCK_CIPHER_SW_OFB_Decrypt (BLOCK_CIPHER_SW_HANDLE handle, uint8_t * plainText, uint32_t *  numPlainBytes, uint8_t * cipherText, uint32_t numCipherBytes, uint32_t options);
#define BLOCK_CIPHER_SW_OFB_Decrypt      BLOCK_CIPHER_SW_OFB_Encrypt
...
*/
BLOCK_CIPHER_SW_ERRORS BLOCK_CIPHER_SW_OFB_KeyStreamGenerate (BLOCK_CIPHER_SW_HANDLE handle, uint32_t numBlocks, uint32_t options);

#endif      // _BLOCK_CIPHER_SW_OFB_H
