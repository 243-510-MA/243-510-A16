...
#define SALSA20_SW_RotateL32wC(a,d)           ((((uint32_t)a) << d) | (((uint32_t)a) >> (32 - d)))

#define SALSA20_SW_QuarterRound(a,b,c,d)       (b = b ^ (SALSA20_SW_RotateL32wC(a+d, 7))); \
                                            (c = c ^ (SALSA20_SW_RotateL32wC(b+a, 9))); \
                                            (d = d ^ (SALSA20_SW_RotateL32wC(c+b, 13))); \
                                            (a = a ^ (SALSA20_SW_RotateL32wC(d+c, 18)));
