...
//Project Source Code Directory Path details ----
//        Element DefaultProjectSourceCodeDirectory = doc.createElement("Setting");
//        DefaultProjectSourceCodeDirectory.setAttribute("Name", "DefaultProjectSourceCodeDirectory");
//        DefaultProjectSourceCodeDirectory.setAttribute("Type", "String");
//        DefaultProjectSourceCodeDirectory.setAttribute("Scope", "User");
//        value = doc.createElement("Value");
//        //value.appendChild(doc.createTextNode("C:\\Microchip Solutions\\TCPIP\\Demo App\\WebPages2"));
//        value.appendChild(doc.createTextNode(MPFS2.defaultProjectSourceCodeDirectoryPath));
//        DefaultProjectSourceCodeDirectory.appendChild(value);
//        rootElement.appendChild(DefaultProjectSourceCodeDirectory);

        Element projectSourceCodeDirectory_new = doc.createElement("Setting");
        //SourceDirectory_new.appendChild(value);
        projectSourceCodeDirectory_new.setAttribute("Name",
                (String)MPFS2.xmlAttrInfoMap.get(MainMPFS.eXmlNodeAttribute.PROJECT_DIRECTORY_PATH));
        projectSourceCodeDirectory_new.setAttribute("Type", "String");
        //projectSourceCodeDirectory_new.setAttribute("Scope", "User");
        value = doc.createElement("Value");
        //value.appendChild(doc.createTextNode("..//..//..//TCPIP//Demo App//WebPages2"));
        value.appendChild(doc.createTextNode(MPFS2.projectSourceCodeDirectoryPath));
        projectSourceCodeDirectory_new.appendChild(value);
        rootElement.appendChild(projectSourceCodeDirectory_new);

//        Element projectSourceCodeDirectory_old = doc.createElement("Setting");
//        //SourceDirectory_new.appendChild(value);
//        projectSourceCodeDirectory_old.setAttribute("Name", "ProjectSourceCodeDirectory_old");
//        projectSourceCodeDirectory_old.setAttribute("Type", "String");
//        projectSourceCodeDirectory_old.setAttribute("Scope", "User");
//        value = doc.createElement("Value");
//        //value.appendChild(doc.createTextNode("..//..//..//TCPIP Demo App//WebPages2"));
//        value.appendChild(doc.createTextNode(MPFS2.projectSourceCodeDirectoryPath_old));
//        projectSourceCodeDirectory_old.appendChild(value);
//        rootElement.appendChild(projectSourceCodeDirectory_old);
...
//    </Setting>
       ...
       // generateImageName.setAttribute("Scope","User");
        value = doc.createElement("Value");
        value.appendChild(doc.createTextNode("mpfs_img2"));
            ...
            while(getNext()==true)
            {
                ...
                switch(nIteration)
                {
                    ...
                    case 1: //PROJECT_DIRECTORY_PATH
                        if(sType.contains("String"))
                            MPFS2.projectSourceCodeDirectoryPath = v_NodeValue.get(iLoop).toString();
                        else
                            return false;
                        break;
