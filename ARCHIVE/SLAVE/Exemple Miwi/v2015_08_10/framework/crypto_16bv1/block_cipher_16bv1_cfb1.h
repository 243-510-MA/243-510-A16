...
#if !defined (_BLOCK_CIPHER_16BV1_CFB1_H)
#define _BLOCK_CIPHER_16BV1_CFB1_H
...
typedef struct
{
    ...
    uint8_t bitCount;
    uint8_t textTemp;
} BLOCK_CIPHER_16BV1_CFB1_CONTEXT;

// *****************************************************************************
/* Function:
    BLOCK_CIPHER_ERRORS BLOCK_CIPHER_16BV1_CFB1_Initialize (BLOCK_CIPHER_HANDLE handle,
  ...
  Example:
    ...
    error = BLOCK_CIPHER_16BV1_CFB1_Initialize (handle, &context, CRYPTO_16BV1_ALGORITHM_AES, CRYPTO_16BV1_ALGORITHM_AES, AES_BLOCK_SIZE, initialization_vector, AESKey128, CRYPTO_KEY_SOFTWARE, CRYPTO_AES_128_KEY);
...
/*********************************************************************************************************************************************************************************************************************
  Function:
    BLOCK_CIPHER_ERRORS BLOCK_CIPHER_16BV1_CFB1_Encrypt (BLOCK_CIPHER_HANDLE handle,
  ...
  Example:
    <code>
    // ***************************************************************
    // Encrypt data in CFB1 mode with the AES algorithm.
    // ***************************************************************
...
// *****************************************************************************
/* Function:
    BLOCK_CIPHER_ERRORS BLOCK_CIPHER_16BV1_CFB1_Decrypt (BLOCK_CIPHER_HANDLE handle,
...
#endif      // _BLOCK_CIPHER_16BV1_CFB1_H
