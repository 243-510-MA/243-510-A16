...
#if !defined (_BLOCK_CIPHER_16BV1_CFB_H)
#define _BLOCK_CIPHER_16BV1_CFB_H
...
/* Function:
  ...
  Example:
    ...
    error = BLOCK_CIPHER_16BV1_CFB_Initialize (handle, &context, CRYPTO_16BV1_ALGORITHM_AES, CRYPTO_16BV1_ALGORITHM_AES, AES_BLOCK_SIZE, initialization_vector, &AESKey128, CRYPTO_KEY_SOFTWARE, CRYPTO_AES_128_KEY);
...
// *****************************************************************************
/* Function:
    BLOCK_CIPHER_ERRORS BLOCK_CIPHER_16BV1_CFB_Decrypt (BLOCK_CIPHER_HANDLE handle,
...
#endif      // _BLOCK_CIPHER_16BV1_CFB_H
